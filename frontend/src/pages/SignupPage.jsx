  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(135deg,#0e0e0e_0%,#151616_48%,#0e0e0e_100%)] text-on-surface font-body selection:bg-tertiary-container selection:text-on-tertiary-container">
      ...
      <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-5 py-32 sm:px-6">
        {/* Decorative Icons */}
        <span
          className="material-symbols-outlined pointer-events-none absolute right-[10%] top-[14%] hidden text-5xl text-tertiary/20 sm:block"
          aria-hidden="true"
        ...
        <span
          className="material-symbols-outlined pointer-events-none absolute bottom-[18%] left-[10%] hidden text-3xl text-tertiary/15 sm:block"
          aria-hidden="true"
        >
          menu_book
        </span>
        <span
          className="material-symbols-outlined pointer-events-none absolute bottom-[35%] right-[8%] hidden text-2xl text-tertiary/10 sm:block"
          aria-hidden="true"
        >
          psychology
        </span>
          ...
          <div className="rounded-xl border border-outline-variant/20 bg-surface-container/70 p-7 shadow-2xl backdrop-blur-2xl sm:p-10">
            ...
            <div className="mb-10 text-center sm:mb-12">
              ...
              <p className="text-sm leading-6 text-on-surface-variant">
                Start transforming any topic into a structured, AI-powered
                learning experience.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <span className="material-symbols-outlined mt-0.5 text-lg text-tertiary-fixed">
                  school
                </span>
                <div>
                  ...
                  <p className="text-xs text-on-surface-variant">
                    Turn any topic into structured learning modules instantly.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-on-surface-variant">
                    Curated video links mapped to each lesson topic.
                  </p>
                </div>
              </div>
            </div>
